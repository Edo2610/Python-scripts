...
def main():
    ...
    for i in range(len(model_list)):
        test_acc, f1_test, cm, out, labels, _ = tester.test(model_list[i], device, loaders[i], test_size, model_name[i])
...
if __name__ == "__main__":
    ...
    label, preds, classes, cm = main()
    utils.auc_score(label, preds, classes)
